...
'hadits-wasiat-ahli-waris': {
    ...
    'atsar-umar-musyarakah': {
      ...
      terjemah: 'في مسألة شغلت فيها نصيبُ الزوج والأم والإخوة لأم الميراث كلها حتى لم يبق ' +
    ...
    'harta-bersama': {
      ...
      sumber: 'هذا حكم قانون الأسرة الجزائري، لا دليلُ ميراثٍ. لا توجد فكرة «مال مشترك» ' +
        'تلقائية تخرج نصف الميراث قبل القسمة؛ بل تُثبت المشاركةُ بالبيِّنة، والأصل أن كل ' +
