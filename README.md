...
css/
  tokens.css            نسخة حرفية من flavida-design-system
...
الملفات في `assets/` (علامة الزهرة وتميمة Flav) أصولٌ تخص **Flavida** ولا يُقصد إعادة استخدامها
