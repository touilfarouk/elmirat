...
<p align="center">
  <em>حاسبة تقسيم الميراث وفق الشريعة الإسلامية — باللغة العربية</em>
  <br>
  <b>by Touil</b>
</p>
...
- **حساب الميراث بالترتيب الصحيح:** تجهيز الجنازة ← سداد الديون ← تنفيذ الوصايا ← ثم توزيع الباقي.
...
## العقيدة المشروحة في الحساب: ترتيب الميراث

1. **تجهيز الميت** (تكفين ونحو ذلك) من ماله.
2. **الديون** المستحقة على الميت.
3. **الوصايا** في حدود الثلث.
4. الباقي = **الميراث الصافي × توزّع على الورثة** بالأنصبة الشرعية.
...
js/faraid/              محرك الحساب — نقي، بلا أي تعامل مباشر مع DOM
  ...
  estate.js             الميراث: الملكية بين الزوجين، تجهيز، ديون، وصايا
...
الحالات الخاصة المُسمّاة، قواعد الحجب، حساب الميراث، واستخراج قائمة الورثة من بنية العائلة —
